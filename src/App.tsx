    ...
    <div className="min-h-screen font-sans selection:bg-white selection:text-black overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 bg-black/50 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center shadow-[0_0_20px_rgba(59,130,246,0.4)]">
          ...
          <button className="px-6 py-2.5 bg-blue-500 text-white text-sm font-bold rounded-full hover:bg-blue-400 transition-colors shadow-lg shadow-blue-500/20">
            Get App
          </button>
        </div>
      </nav>
      ...
      <section ref={heroRef} className="relative pt-32 pb-20 px-6 overflow-hidden min-h-screen flex flex-col justify-center">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <motion.div 
            style={{ y: y2 }}
            className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-cyan-500/10 rounded-full blur-[120px] animate-pulse-slow" 
            transition={{ delay: 2 }}
          />
              ...
              {[...Array(40)].map((_, i) => (
                <motion.div
                  ...
                  animate={{ 
                    ...
                    backgroundColor: i % 2 === 0 ? "rgba(59,130,246,0.2)" : "rgba(6,182,212,0.2)"
                  }}
                  transition={{ 
        ...
        <div className="max-w-7xl mx-auto w-full relative">
          ...
          <div className="absolute inset-0 pointer-events-none z-0">
            <motion.div 
              ...
              className="absolute top-[-40px] right-[10%] glass p-3 md:p-4 rounded-2xl shadow-xl border-blue-500/20"
            >
            ...
            <motion.div 
              ...
              className="absolute bottom-[20%] left-[-20px] md:left-[5%] glass p-3 md:p-4 rounded-2xl shadow-xl border-cyan-500/20"
            >
            ...
            <motion.div 
              ...
              className="absolute top-[40%] right-[-10px] md:right-[15%] glass p-2 md:p-3 rounded-xl shadow-lg border-blue-500/20"
            >
            ...
            <motion.div 
              ...
              className="absolute top-[10%] left-[20%] glass p-2 md:p-3 rounded-xl shadow-lg border-cyan-500/20"
            >
              <Volume2 className="text-cyan-400/80" size={18} />
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute bottom-[-20px] right-[30%] glass p-2 md:p-3 rounded-xl shadow-lg border-blue-500/20"
            >
              <Music2 className="text-blue-500/80" size={18} />
            </motion.div>
          </div>
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-xs font-bold tracking-widest uppercase text-blue-400 border-blue-500/20">
              <span className="w-2 h-2 bg-blue-500 rounded-full animate-pulse" />
              Now Available for Android
            </div>
            <h1 className="text-6xl md:text-8xl font-display font-bold tracking-tighter leading-[0.9]">
              Feel the music <br />
              <span className="text-blue-500/40 italic">in a new light</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a 
                href="#download"
                className="px-8 py-4 bg-blue-500 text-white font-bold rounded-2xl hover:scale-105 transition-transform flex items-center justify-center gap-2 shadow-xl shadow-blue-500/20"
              >
                <Download size={20} />
                Download App
              </a>
      ...
      <section id="download" className="py-32 px-6">
        <div className="max-w-5xl mx-auto glass rounded-[3rem] p-12 md:p-20 text-center space-y-10 relative overflow-hidden">
          ...
          <div className="flex flex-col items-center gap-6">
            <a 
              href="https://github.com/infasmk/Lume_Music/releases/download/3.01.25%2B9/Lume.V3.01.25+9.apk"
            ...
            >
              <Download size={24} />
              Download APK v3.01.25+9
            </a>
            <div className="space-y-2">
              <p className="text-sm text-white/40">Version3.01.25+9 • 49MB • Android 8.0+</p>
          ...
          <div className="pt-10 border-t border-white/5 grid grid-cols-3 gap-8">
            <div>
              <p className="text-3xl font-bold font-display text-blue-500">5k+</p>
              <p className="text-xs text-white/40 uppercase tracking-widest">Downloads</p>
            </div>
            <div>
              <p className="text-3xl font-bold font-display text-cyan-400">4.9/5</p>
              <p className="text-xs text-white/40 uppercase tracking-widest">Rating</p>
            </div>
            <div>
              <p className="text-3xl font-bold font-display text-blue-500">24/7</p>
      ...
      <section className="py-32 px-6 bg-zinc-950/50">
        <div className="max-w-3xl mx-auto text-center space-y-12">
          ...
          <div className="grid gap-6">
            {[
              { title: "Redesigned Player", desc: "A more intuitive and beautiful playback interface.", color: "text-blue-500" },
              { title: "Smart Cache", desc: "Improved offline management and faster loading.", color: "text-cyan-400" },
              { title: "Lossless Audio", desc: "Support for FLAC and high-bitrate streaming.", color: "text-blue-500" }
            ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full glass flex items-center justify-center hover:bg-blue-500/20 hover:text-blue-500 transition-colors">
                <Instagram size={18} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full glass flex items-center justify-center hover:bg-cyan-500/20 hover:text-cyan-400 transition-colors">
                <Zap size={18} />
              </a>
            </div>
          </div>
